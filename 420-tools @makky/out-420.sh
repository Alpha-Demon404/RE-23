...
while [ $lagi -lt 6 ];
do
echo "TOOLS INSTALLER SECURITY XPLOITER CREW" | lolcat
echo "TOOLS INI BERISI 420 TOOLS" | lolcat
sleep 3
clear
echo  "_____________________________________________________________" | lolcat
echo ""
toilet -f pagga "   Security_XC"|lolcat
echo  "_____________________________________________________________" | lolcat
sleep 1
echo "_________________________" | lolcat
echo "1.INSTALL BAHAN" | lolcat
echo "_________________________" | lolcat
echo "2.SHOW ALL TOOLS"| lolcat
echo "_________________________" | lolcat
read -p "[PILIH]-->" hsnaysubshsn
case $hsnaysubshsn in
4) clear
;;
1) clear
...
ctrl_c() {
clear
echo  "TOOLS YANG KALIAN INSTALL ADA DI DIRECTORY" |lolcat
echo  "SALAM SECURITY XPLOITER CREW" | lolcat
sleep 1
exit
}
echo ""
...
echo ""
echo -e "============================" | lolcat
echo -e $b "1000.CHAT ADMIN VIA WA"
echo -e "============================" | lolcat
echo -e $b "H. INFORMATION THIS TOOLS"
echo -e "============================" | lolcat
echo -e $b "E. EXIT"
echo -e "============================" | lolcat
...
echo -e "============================" | lolcat
echo -e $b "404. Install dark-fb VIP"
echo -e "============================" | lolcat
echo -e $b "405. Install Yt-Downloader"
echo -e "============================" | lolcat
echo -e $b "406. Install DorkScanner"
echo -e "============================" | lolcat
echo -e $b "407. Install Camstream v3"
echo -e "============================" | lolcat
echo -e $b "408. Install PHP-BackConnector"
echo -e "============================" | lolcat
echo -e $b "409. Install BoxSosmed"
echo -e "============================" | lolcat
echo -e $b "410. Install Kali-linux_For_Termux "
echo -e "============================" | lolcat
echo -e $b "411. Install Mail_Spammer"
echo -e "============================" | lolcat
echo -e $b "412. Install Spam_Call"
echo -e "============================" | lolcat
echp -e $b "413. Install Yt_Downloader"
echo -e "============================" | lolcat
echo -e $b "414. Install Dork_Scanner"
echo -e "============================" | lolcat
echo -e $b "415. Install REV_ip"
echo -e "============================" | lolcat
echo -e $b "416. Install Instahack V3"
echo -e "============================" | lolcat
echo -e $b "417. Install Check_ip"
echo -e "============================" | lolcat
echo -e $b "418. Install Ddos"
echo -e "============================" | lolcat
echo -e $b "419. Install Admin_Finder"
echo -e "============================" | lolcat
echo -e $b "420. Install Admin_FinderV2"
echo -e "============================" | lolcat
...
;;
403) clear
echo "UDAH DI BILANG JANGAN DI INSTALL"
echo "WAIT BROO INI BAKAL INSTALL HACK INSTAGRAM AUTO LOGIN"
sleep 980
echo "CIEEE NUNGGUIN YA?"
echo "ITS PRANK MADAFAKA"
;;
404) clear
git clone https://github.com/Makky_Kun-404/DARK-FB-VIP
;;
405) git clone https://github.com/KALSELeXploit/YOUTUBE-DOWNLOADER
;;
406) git clone https://github.com/KALSELeXploit/DORK-SCANNER
;;
407) echo "SEBAIK NYA JANGAN....."
echo "EXIT...."
;;
408) git clone https://github.com/shawarkhanethicalhacker/PHP-BackConnector
;;
409) git clone https://github.com/Xeit666h05t/BoxSosmed
;;
410) clear
echo "ERROR" | lolcat
;;
411) git clone https://github.com/KALSELeXploit/MAIL-SPAMMER
cd MAIL-SPAMMER
php mail.php
;;
412) git clone https://github.com/KALSELeXploit/SPAM-CALL
cd SPAM-CALL
bash CaLL.sh
;;
413) git clone https://github.com/KALSELeXploit/YOUTUBE-DOWNLOADER
cd YOUTUBE-DOWNLOADER
python2 youtube.py
;;
414) git clone https://github.com/KALSELeXploit/DORK-SCANNER
cd DORK-SCANNER
php scan.php
;;
415) git clone https://github.com/KALSELeXploit/REV-IP
cd REV-IP
python3 rev.io
;;
416) git clone https://github.com/KALSELeXploit/INSTAHACK
cd INSTAHACK
python2 insta.py
;;
417) git clone https://github.com/KALSELeXploit/CHECK-IP
cd CHECK-IP
python2 checkip.py
;;
418) git clone https://github.com/KALSELeXploit/DDoS
cd DDoS
python2 ddos.py
;;
419) git clone https://github.com/KALSELeXploit/AdminFinder
cd AdminFinder
python2 admin.py
;;
420) git clone https://github.com/KALSELeXploit/AdminFinder
cd AdminFinder
python2 admin.py
;;
H) clear
echo "_____________________________________________________________" | lolcat
echo "TOOLS INI DI BUAT OLEH MAKKY_KUN" | lolcat
echo "_____________________________________________________________" | lolcat
echo "TOOLS INI DI CIPTAKAN UNTUK MEMBANTU NEWBIE YANG SUKA MINTA SC" | lolcat
echo "_____________________________________________________________" | lolcat
echo "DEMIKIAN DARI INFORMASI TADI YANG MUNGKIN BAGUS KAN :V" | lolcat
echo "_____________________________________________________________" | lolcat
echo "OH YA TOOLS INI AKAN TERUS UPDATE KOK" | lolcat
echo "_____________________________________________________________" | lolcat
echo "KALO BISA MUNGKIN SAMPAI 1000 TOOLS" | lolcat
echo "_____________________________________________________________" | lolcat
echo ""
read -p "OH YA NAMA LU SIAPA?:" namasirusj
echo "THANKS" $namasirusj "UDAH MAU BERKUNJUNG"
sleep 3
clear
echo "EXITTING..." | lolcat
exit
;;
h) clear
echo "_____________________________________________________________" | lolcat
...
exit
;;
00) echo "Author : Makky_Kun"
exit
;;
1000) clear
xdg-open https://api.whatsapp.com/send?phone=6285726201352
;;
*) echo "Fix Mata Lu Minus"
esac
done
done
